# Developed/contributed by Eli, Perlynn, Patty; modified by Ken
from pymongo import MongoClient
import pandas as pd
import os

### ROW 112 have some limiatations to FOL -- not complete!!!!!


def collect_scr_oh_transit_from_scdx_poc(pcba_site):
    # %% connect to SCDx

    SCDX_URI=os.getenv('SCDX_POC')
