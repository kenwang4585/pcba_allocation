...
def send_allocation_result(email_option,output_filename,file_3a4,file_supply,size_3a4,size_supply,bu_list,pcba_site,login_user):
    """
    Send the allocation result to defined users by email
    """
    subject = '{} site PCBA allocation result generated by {}'.format(pcba_site, login_user)
    html_template='allocation_email.html'
    ...
    if email_option=='to_me':
        ...
        send_attachment_and_embded_image(to_address, subject, html_template, att_filenames=att_files_allocation,
